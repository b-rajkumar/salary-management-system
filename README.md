...
- **Backend tests** per layer (64 total); **frontend RTL** tests covering hooks, components, and the page (40 total).
...
- **Delete employee (FR-4).** The dialog is already the natural canvas — a Delete button joins Edit when this lands.
